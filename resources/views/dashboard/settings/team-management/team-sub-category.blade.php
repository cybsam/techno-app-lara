...
@section('title', 'Blank Page - Techno Apogee')
  ...
  <div class="card">
      <div class="card-header">
          <div class="float-right">
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addteammember">+ Management Degination</button>
          </div>
      </div>
      <div class="card-body">
