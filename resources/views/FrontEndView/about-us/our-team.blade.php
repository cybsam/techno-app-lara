...
@section('title', 'Our Team ~ About Us | Techno Apogee')
@section('content')
                    ...
                    @foreach ($management as $key => $management)
                        <div class="managementTem m-auto text-center">
                            <div class="managementTemImg">
                                <img src="{{ asset('image/about-us/our-team') }}/{{ $management->image }}" alt="">
                            </div>
                    ...
                    <div class="team-member">
                        <figure class="effect-zoe">
                            <div class="team-photo">
                                <img src="{{ asset('image/about-us/our-team') }}/{{ $admin_operation->image }}"
            ...
            @foreach ($business_development as $key => $business_development)
                <div class="col-md-4">
                    <div class="team-member">
                        <figure class="effect-zoe">
                            <div class="team-photo">
                                <img src="{{ asset('image/about-us/our-team') }}/{{ $business_development->image }}"
            ...
            @foreach ($information_technology_design as $key => $information_technology_design)
                <div class="col-md-4">
                    <div class="team-member">
                        <figure class="effect-zoe">
                            <div class="team-photo">
                                <img src="{{ asset('image/about-us/our-team') }}/{{ $information_technology_design->image }}"
            ...
            @foreach ($project_engineering_operation_department as $key => $project_engineering_operation_department)
                <div class="col-md-4">
                    <div class="team-member">
                        <figure class="effect-zoe">
                            <div class="team-photo">
                                <img src="{{ asset('image/about-us/our-team') }}/{{ $project_engineering_operation_department->image }}"
            ...
            @foreach ($support_team_electrical_maintenance as $key => $support_team_electrical_maintenance)
                <div class="col-md-4">
                    <div class="team-member">
                        <figure class="effect-zoe">
                            <div class="team-photo">
                                <img src="{{ asset('image/about-us/our-team') }}/{{ $support_team_electrical_maintenance->image }}"
