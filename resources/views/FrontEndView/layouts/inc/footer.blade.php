                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12 md-mb-10 pl-55 md-pl-15">
                            ...
                            <ul class="site-map">
                                <li><a href="{{ route('frontEndIndex.ProductAndService',['slug'=>'design-consultancy-service']) }}">DESIGN & CONSULTANCY</a></li>
                                <li><a href="{{ route('frontEndIndex.ProductAndService',['slug'=>'busbar-trunking-bbt-systems']) }}">HVAC & BBT SOLUTIONS</a></li>
                                <li><a href="{{ route('frontEndIndex.ProductAndService',['slug'=>'fire-detection-system']) }}">FIRE SOLUTION</a></li>
