...
@section('title', $blogDetailesView->__blog_name.' | Techno Apogee Limited')
                ...
                <div class="container pb50">
                    <div class="row">
                        <div class="col-md-9 mb40">
                            <article>
                                <img src="{{ asset('image/blog') }}/{{ $blogDetailesView->__blog_header_image }}" alt="" class="img-fluid mb30">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="media">
                                        <img class="d-flex mr-3 img-fluid" width="64"
                                            src="{{ asset('image/blog') }}/{{ $reletedBlog->__blog_header_image }}"
